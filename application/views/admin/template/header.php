  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="<?= base_url() ?>" class="brand-link">
        <img src="<?= base_url() ?>assets/image/other/logo_application.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="<?= base_url() ?>assets/#" class="d-block"><?= $this->session->userdata('name') ?> - Job Portal</a>
          </div>
        </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="<?= base_url() ?>admin/job" class="nav-link <?= ($current_page == 'job') ? 'active' : '' ?>">
            ...
            <li class="nav-item">
              <a href="<?= base_url() ?>admin/job_applicant" class="nav-link  <?= ($current_page == 'job_applicant') ? 'active' : '' ?>">
